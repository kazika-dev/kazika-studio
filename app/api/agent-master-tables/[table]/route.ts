...
const TABLES: Record<string, TableConfig> = {
  ...
  character_voice_profiles: { table: 'character_voice_profiles', orderBy: 'updated_at desc, id desc', required: ['character_id', 'name'], fields: { character_id: 'number', name: 'text', provider: 'text', model: 'text', voice_prompt: 'text', voice_seed: 'number', voice_num_steps: 'number', is_default: 'boolean', metadata: 'json' } },
