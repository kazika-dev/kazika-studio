...
const TABLES: Record<string, TableConfig> = {
  ...
  stories: { table: 'stories', orderBy: 'updated_at desc, id desc', required: ['title'], fields: { title: 'text', description: 'text', thumbnail_url: 'text', default_image_aspect_ratio: 'text', default_video_aspect_ratio: 'text', metadata: 'json' } },
