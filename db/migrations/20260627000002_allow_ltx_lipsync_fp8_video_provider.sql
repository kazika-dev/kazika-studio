...
alter table kazika_studio_agents.script_lines
  ...
  check (video_generation_provider in ('grok', 'ltx_2_3_i2v', 'ltx_2_3_flf2v', 'ltx_2_3_flf2v_lipsync', 'ltx_2_3_lipsync_fp8'));

comment on column kazika_studio_agents.script_lines.video_generation_provider is
  'Line-level video generation provider selected in Agent Scene UI: grok, ltx_2_3_i2v, ltx_2_3_flf2v, ltx_2_3_flf2v_lipsync, or ltx_2_3_lipsync_fp8.';
